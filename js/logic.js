...
function canUserPerform(action) {
    ...
    switch(action) {
        ...
        case 'USE_SUPABASE': return config.useSupabase;
        case 'USE_DRIVE': return config.useDrive;
        ...
        case 'SAVE_ATTACHMENTS': return config.canSaveAttachments;
        case 'ADVANCED_DRUMS': return config.hasAdvancedDrums;
