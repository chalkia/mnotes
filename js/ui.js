...
/* ===========================================================
   GUITAR CHORDS GENERATOR (SVG) - v1.1
   =========================================================== */
const GuitarChordsUI = {
    // Διαβάζει το λεξικό δυναμικά από το data.js
    db: typeof CHORD_DICTIONARY !== 'undefined' ? CHORD_DICTIONARY : {},
    
    currentVoicings: {}, // Θυμάται ποια παραλλαγή βλέπει ο χρήστης
    ...
    scanAndRender: function() {
        ...
        // Σαρώνουμε το τραγούδι για συγχορδίες
        ...
        uniqueChords.forEach(chordName => {
            ...
            // Debugging για άγνωστες συγχορδίες στο κείμενο
            if (!voicings) {
                console.warn(`[GuitarChordsUI] Προσοχή: Η συγχορδία '${chordName}' δεν υπάρχει στο λεξικό.`);
                return; // Προσπερνάμε για να μην σπάσει το UI
            }
